...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'Betreff Titel';
   var tocTool1 = 'Click to sort by title';
   var tocHead2 = 'Geschichte';
   var tocTool2 = 'Click to sort by date';
   var tocHead3 = 'Kategorien';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note"> Anzahl der Themen ' + postTitle.length + ' Thema<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Anzahl der Themen ' + numDisplayed + ' Abschnitt \'';
      tocNote += postFilter + '\' *** '+ postTitle.length + ' Gesamtzahl der Fächer<br/></span>';
   }
